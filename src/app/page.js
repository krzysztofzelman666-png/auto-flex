  ...
  return (
    <main style={{ background: "#f8fafc", minHeight: "100vh" }}>
      ...
      <div style={{ background: "#0f172a", padding: "40px 24px 48px" }}>
        <p style={{ color: "#60a5fa", fontSize: "13px", letterSpacing: "2px", margin: "0 0 8px", textTransform: "uppercase" }}>
          Wynajem samochodów
        </p>
        <h1 style={{ color: "#fff", fontSize: "28px", fontWeight: "500", margin: "0 0 16px" }}>
        ...
        <div style={{
          ...
          <input
            ...
            style={{ flex: 1 }}
          />
          <span style={{ color: "#60a5fa", fontSize: "15px", fontWeight: "500", minWidth: "20px" }}>
            {dni}
          </span>
        </div>
      </div>
            ...
            {listaAut.map((auto) => (
              <div key={auto.id} style={{
                ...
                <div style={{
                  ...
                  <span style={{ color: "#60a5fa", fontSize: "13px", fontWeight: "500", letterSpacing: "1px" }}>
                    {auto.rok ?? "—"}
                  </span>
                </div>

                <div style={{ padding: "14px 16px" }}>
                  <p style={{ fontSize: "15px", fontWeight: "500", color: "#0f172a", margin: "0 0 4px" }}>
                    {auto.nazwa}
                  </p>
                  {auto.opis && (
                  ...
                  <div style={{ display: "flex", alignItems: "baseline", gap: "4px", margin: "0 0 12px" }}>
                    <span style={{ fontSize: "20px", fontWeight: "500", color: "#2563eb" }}>
